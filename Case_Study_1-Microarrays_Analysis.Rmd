...
author: "Diego Vallarino based on Gonzalo, Ricardo and Sanchez-Pla, Alex (2019)"
date: "March 15, 2020"
output:
  pdf_document:
...
**NOTE**: 
This has been a work that implied, by Diego Vallarino, PhD, only the replicability of the work of Gonzalo, Ricardo and Sanchez-Pla, Alex (2019). Therefore, all errors related to this document are the responsibility of the author of the reproduction of the work. 
...
```{r ReadTargets}
targets <- read.csv2("C:/Users/diego/OneDrive/Documentos/GitHub/Omics_Data_Analysis-Case_Study_1-Microarrays/data/targets.csv", header = TRUE, sep = ";") 
knitr::kable(
...
arrayQualityMetrics(eset_rma, outdir = file.path("C:/Users/diego/OneDrive/Documentos/GitHub/Omics_Data_Analysis-Case_Study_1-Microarrays/results", "QCDir.Norm"), force=TRUE)
```
